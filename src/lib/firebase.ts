...
if (missingVars.length > 0) {
  const errorMessage = `CRITICAL ERROR: Firebase/Google Maps configuration is missing required environment variables: ${missingVars.join(', ')}. Please check your Vercel environment variable settings or .env file.`;
